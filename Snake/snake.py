...
while run:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_LEFT and snake_vel[0] != speed:
                snake_vel = [-speed, 0]
            elif event.key == pygame.K_RIGHT and snake_vel[0] != -speed:
                snake_vel = [speed, 0]
            elif event.key == pygame.K_UP and snake_vel[1] != speed:
                snake_vel = [0, -speed]
            elif event.key == pygame.K_DOWN and snake_vel[1] != -speed:
                snake_vel = [0, speed]
